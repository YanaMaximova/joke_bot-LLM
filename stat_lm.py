...
def construct_model():
    ...
    stat_lm_path = os.path.join(Path().absolute(), 'models/stat_lm/stat_lm.pkl')
    tokenizer_path = os.path.join(Path().absolute(), 'models/stat_lm/tokenizer.pkl')
    print(f'****{tokenizer_path} {stat_lm_path}')
